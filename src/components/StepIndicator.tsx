...
export function StepIndicator({ currentStep, onStepClick }: StepIndicatorProps) {
  return (
    <nav className="sidebar-pipeline" aria-label="Pasos del proceso">
      {STEPS.map((step, index) => {
        ...
        return (
          <div key={step.n} className="sidebar-step">
            <div className="sidebar-step-track">
              ...
              {index < STEPS.length - 1 && (
                <div className={`sidebar-step-connector${isDone ? ' sidebar-step-connector--done' : ''}`} />
              )}
            </div>
            <div className="sidebar-step-label-wrap">
              <span
