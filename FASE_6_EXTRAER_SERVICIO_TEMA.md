...
- [x] Crear clase ThemeService con cache estático
- [x] loadTemplate() - cargar base.elpx
- [x] loadTheme() - cargar tema + prefixar
- [x] loadThemeIfNeeded() - helper para conditionals
- [x] fetchAndUnzip() - helper privado

### Paso 2: Refactorizar docxToElpx.ts (15 min)
- [x] Importar ThemeService
- [x] Actualizar convertDocxToElpx() para usar ThemeService.loadTheme()
- [x] Actualizar convertProjectToElpx() para usar ThemeService.loadTemplate()
- [x] Remover loadThemeEntries() y loadBaseTemplate()

### Paso 3: Validar (10 min)
- [x] TypeScript compile sin errores
- [x] Build exitoso
- [x] No cambiar XML output
...
**RESULTADO**: ✅ ThemeService listo para Fase 7
